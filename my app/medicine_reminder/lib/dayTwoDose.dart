...
class dayTwoDose extends StatefulWidget {
  const dayTwoDose({Key? key}) : super(key: key);

  @override
  _dayTwoDoseState createState() => _dayTwoDoseState();
}

class _dayTwoDoseState extends State<dayTwoDose> {
  ...
  void _saveButton() {
    ...
    dbref.update({'monday/dose_1Hour': doseOneHour});
    dbref.update({'monday/dose_1Minute': doseOneMinute});

    dbref.update({'monday/dose_2Hour': doseTwoHour});
    dbref.update({'monday/dose_2Minute': doseTwoMinute});

    dbref.update({'monday/dose_3Hour': doseThreeHour});
    dbref.update({'monday/dose_3Minute': doseThreeMinute});
