...
class dayOneDose extends StatefulWidget {
  const dayOneDose({Key? key}) : super(key: key);

  @override
  _dayOneDoseState createState() => _dayOneDoseState();
}

class _dayOneDoseState extends State<dayOneDose> {
  ...
  void _saveButton() {
    ...
    dbref.update({'sunday/dose_1Hour': doseOneHour});
    dbref.update({'sunday/dose_1Minute': doseOneMinute});

    dbref.update({'sunday/dose_2Hour': doseTwoHour});
    dbref.update({'sunday/dose_2Minute': doseTwoMinute});

    dbref.update({'sunday/dose_3Hour': doseThreeHour});
    dbref.update({'sunday/dose_3Minute': doseThreeMinute});
