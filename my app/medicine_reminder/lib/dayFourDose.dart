...
class dayFourDose extends StatefulWidget {
  const dayFourDose({Key? key}) : super(key: key);

  @override
  _dayFourDoseState createState() => _dayFourDoseState();
}

class _dayFourDoseState extends State<dayFourDose> {
  ...
  void _saveButton() {
    ...
    dbref.update({'wednesday/dose_1Hour': doseOneHour});
    dbref.update({'wednesday/dose_1Minute': doseOneMinute});

    dbref.update({'wednesday/dose_2Hour': doseTwoHour});
    dbref.update({'wednesday/dose_2Minute': doseTwoMinute});

    dbref.update({'wednesday/dose_3Hour': doseThreeHour});
    dbref.update({'wednesday/dose_3Minute': doseThreeMinute});
