...
class dayFiveDose extends StatefulWidget {
  const dayFiveDose({Key? key}) : super(key: key);

  @override
  _dayFiveDoseState createState() => _dayFiveDoseState();
}

class _dayFiveDoseState extends State<dayFiveDose> {
  ...
  void _saveButton() {
    ...
    dbref.update({'thursday/dose_1Hour': doseOneHour});
    dbref.update({'thursday/dose_1Minute': doseOneMinute});

    dbref.update({'thursday/dose_2Hour': doseTwoHour});
    dbref.update({'thursday/dose_2Minute': doseTwoMinute});

    dbref.update({'thursday/dose_3Hour': doseThreeHour});
    dbref.update({'thursday/dose_3Minute': doseThreeMinute});
