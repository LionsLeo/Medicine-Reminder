...
class daySixDose extends StatefulWidget {
  const daySixDose({Key? key}) : super(key: key);

  @override
  _daySixDoseState createState() => _daySixDoseState();
}

class _daySixDoseState extends State<daySixDose> {
  ...
  void _saveButton() {
    ...
    dbref.update({'friday/dose_1Hour': doseOneHour});
    dbref.update({'friday/dose_1Minute': doseOneMinute});

    dbref.update({'friday/dose_2Hour': doseTwoHour});
    dbref.update({'friday/dose_2Minute': doseTwoMinute});

    dbref.update({'friday/dose_3Hour': doseThreeHour});
    dbref.update({'friday/dose_3Minute': doseThreeMinute});
