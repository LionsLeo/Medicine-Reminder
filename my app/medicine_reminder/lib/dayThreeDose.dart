...
class dayThreeDose extends StatefulWidget {
  const dayThreeDose({Key? key}) : super(key: key);

  @override
  _dayThreeDoseState createState() => _dayThreeDoseState();
}

class _dayThreeDoseState extends State<dayThreeDose> {
  ...
  void _saveButton() {
    ...
    dbref.update({'tuesday/dose_1Hour': doseOneHour});
    dbref.update({'tuesday/dose_1Minute': doseOneMinute});

    dbref.update({'tuesday/dose_2Hour': doseTwoHour});
    dbref.update({'tuesday/dose_2Minute': doseTwoMinute});

    dbref.update({'tuesday/dose_3Hour': doseThreeHour});
    dbref.update({'tuesday/dose_3Minute': doseThreeMinute});
